...
class CGSharedPreferences {
  static CGSharedPreferences? _singleton;
  static SharedPreferences? _store;

  static Future<CGSharedPreferences?> initialize() async {
    if (_singleton == null) {
      if (_singleton == null) {
        var singleton = CGSharedPreferences._();
